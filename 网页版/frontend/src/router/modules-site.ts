...
export const siteRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: "favorites", name: "favorites", component: () => import("@/views/site/FavoritesView.vue") },
      { path: "compare", name: "compare", component: () => import("@/views/site/CompareView.vue") },
      { path: "guides", name: "guides", component: () => import("@/views/site/GuidesView.vue") },
      { path: "guides/:slug", name: "guide-detail", component: () => import("@/views/site/GuideDetailView.vue") },
      ...
      { path: "me", name: "me", component: () => import("@/views/site/MeView.vue") },
      { path: "reviews/new", name: "review-create", component: () => import("@/views/site/ReviewCreateView.vue") },
    ],
  },
];
